...
// EnqueueBatch forwards to the underlying producer when it supports batching,
// falling back to sequential enqueues otherwise. This keeps the processor
// satisfying BatchEnqueuer while the batching logic lives on the producer.
