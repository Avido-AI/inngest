...
export type GetFunctionsQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export type GetFunctionQueryVariables = Types.Exact<{
  functionSlug: Types.Scalars['String']['input'];
}>;
...
export type InvokeFunctionMutationVariables = Types.Exact<{
  functionSlug: Types.Scalars['String']['input'];
  data: Types.InputMaybe<Types.Scalars['Map']['input']>;
  meta: Types.InputMaybe<Types.Scalars['Map']['input']>;
  user: Types.InputMaybe<Types.Scalars['Map']['input']>;
  debugSessionID?: Types.InputMaybe<Types.Scalars['ULID']['input']>;
  debugRunID?: Types.InputMaybe<Types.Scalars['ULID']['input']>;
}>;


export type InvokeFunctionMutation = { __typename: 'Mutation', invokeFunction: boolean | null };

export type CancelRunMutationVariables = Types.Exact<{
  runID: Types.Scalars['ULID']['input'];
}>;


export type CancelRunMutation = { __typename: 'Mutation', cancelRun: { __typename: 'FunctionRun', id: string } };

export type RerunMutationVariables = Types.Exact<{
  runID: Types.Scalars['ULID']['input'];
  debugRunID?: Types.InputMaybe<Types.Scalars['ULID']['input']>;
  debugSessionID?: Types.InputMaybe<Types.Scalars['ULID']['input']>;
}>;
...
export type RerunFromStepMutationVariables = Types.Exact<{
  runID: Types.Scalars['ULID']['input'];
...
export type GetRunsQueryVariables = Types.Exact<{
  appIDs: Types.InputMaybe<Array<Types.Scalars['UUID']['input']> | Types.Scalars['UUID']['input']>;
  startTime: Types.Scalars['Time']['input'];
  status: Types.InputMaybe<Array<Types.FunctionRunStatus> | Types.FunctionRunStatus>;
  timeField: Types.RunsV2OrderByField;
  functionRunCursor?: Types.InputMaybe<Types.Scalars['String']['input']>;
  celQuery?: Types.InputMaybe<Types.Scalars['String']['input']>;
  preview?: Types.InputMaybe<Types.Scalars['Boolean']['input']>;
  isDeferred?: Types.InputMaybe<Types.Scalars['Boolean']['input']>;
}>;


export type GetRunsQuery = { __typename: 'Query', runs: { __typename: 'RunsV2Connection', edges: Array<{ __typename: 'FunctionRunV2Edge', node: { __typename: 'FunctionRunV2', cronSchedule: string | null, eventName: string | null, id: string, isBatch: boolean, queuedAt: string, endedAt: string | null, startedAt: string | null, status: Types.FunctionRunStatus, hasAI: boolean, isDeferred: boolean, app: { __typename: 'App', externalID: string, name: string }, function: { __typename: 'Function', name: string, slug: string }, deferredFrom: Array<{ __typename: 'RunDeferredFrom', runID: string, function: { __typename: 'Function', name: string, slug: string } }> } }>, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null } } };

export type CountRunsQueryVariables = Types.Exact<{
  startTime: Types.Scalars['Time']['input'];
  status: Types.InputMaybe<Array<Types.FunctionRunStatus> | Types.FunctionRunStatus>;
  timeField: Types.RunsV2OrderByField;
  preview?: Types.InputMaybe<Types.Scalars['Boolean']['input']>;
...
export type GetRunQueryVariables = Types.Exact<{
  runID: Types.Scalars['String']['input'];
  preview: Types.InputMaybe<Types.Scalars['Boolean']['input']>;
}>;


export type GetRunQuery = { __typename: 'Query', run: { __typename: 'FunctionRunV2', status: Types.FunctionRunStatus, hasAI: boolean, function: { __typename: 'Function', id: string, name: string, slug: string, app: { __typename: 'App', name: string, method: Types.AppMethod } }, trace: { __typename: 'RunTraceSpan', name: string, status: Types.RunTraceSpanStatus, attempts: number | null, queuedAt: string, scheduledAt: string | null, startedAt: string | null, endedAt: string | null, isRoot: boolean, isUserland: boolean, outputID: string | null, groupID: string | null, debugRunID: string | null, debugSessionID: string | null, spanID: string, stepID: string | null, stepOp: Types.StepOp | null, stepType: string, childrenSpans: Array<{ __typename: 'RunTraceSpan', name: string, status: Types.RunTraceSpanStatus, attempts: number | null, queuedAt: string, scheduledAt: string | null, startedAt: string | null, endedAt: string | null, isRoot: boolean, isUserland: boolean, outputID: string | null, groupID: string | null, debugRunID: string | null, debugSessionID: string | null, spanID: string, stepID: string | null, stepOp: Types.StepOp | null, stepType: string, childrenSpans: Array<{ __typename: 'RunTraceSpan', name: string, status: Types.RunTraceSpanStatus, attempts: number | null, queuedAt: string, scheduledAt: string | null, startedAt: string | null, endedAt: string | null, isRoot: boolean, isUserland: boolean, outputID: string | null, groupID: string | null, debugRunID: string | null, debugSessionID: string | null, spanID: string, stepID: string | null, stepOp: Types.StepOp | null, stepType: string, childrenSpans: Array<{ __typename: 'RunTraceSpan', name: string, status: Types.RunTraceSpanStatus, attempts: number | null, queuedAt: string, scheduledAt: string | null, startedAt: string | null, endedAt: string | null, isRoot: boolean, isUserland: boolean, outputID: string | null, groupID: string | null, debugRunID: string | null, debugSessionID: string | null, spanID: string, stepID: string | null, stepOp: Types.StepOp | null, stepType: string, childrenSpans: Array<{ __typename: 'RunTraceSpan', name: string, status: Types.RunTraceSpanStatus, attempts: number | null, queuedAt: string, scheduledAt: string | null, startedAt: string | null, endedAt: string | null, isRoot: boolean, isUserland: boolean, outputID: string | null, groupID: string | null, debugRunID: string | null, debugSessionID: string | null, spanID: string, stepID: string | null, stepOp: Types.StepOp | null, stepType: string, userlandSpan: { __typename: 'UserlandSpan', spanName: string | null, spanKind: string | null, serviceName: string | null, scopeName: string | null, scopeVersion: string | null, spanAttrs: string | null, resourceAttrs: string | null } | null, metadata: Array<{ __typename: 'SpanMetadata', scope: SpanMetadataScope, kind: SpanMetadataKind, values: Record<string, unknown>, updatedAt: string }>, stepInfo:
                | { __typename: 'InvokeStepInfo', triggeringEventID: string, functionID: string, timeout: string, returnEventID: string | null, runID: string | null, timedOut: boolean | null }
                | { __typename: 'RunStepInfo', type: string | null }
                | { __typename: 'SleepStepInfo', sleepUntil: string }
                | { __typename: 'WaitForEventStepInfo', eventName: string, expression: string | null, timeout: string, foundEventID: string | null, timedOut: boolean | null }
...
export type GetRunLinkageQueryVariables = Types.Exact<{
  runID: Types.Scalars['String']['input'];
}>;


export type GetRunLinkageQuery = { __typename: 'Query', run: { __typename: 'FunctionRunV2', defers: Array<{ __typename: 'RunDefer', hashedDeferID: string, userlandDeferID: string, fnSlug: string, status: Types.RunDeferStatus, function: { __typename: 'Function', name: string, slug: string } | null, run: { __typename: 'FunctionRunV2', id: string, status: Types.FunctionRunStatus } | null }>, siblingDefers: Array<{ __typename: 'RunDefer', hashedDeferID: string, userlandDeferID: string, fnSlug: string, status: Types.RunDeferStatus, function: { __typename: 'Function', name: string, slug: string } | null, run: { __typename: 'FunctionRunV2', id: string, status: Types.FunctionRunStatus } | null }>, deferredFrom: Array<{ __typename: 'RunDeferredFrom', runID: string, function: { __typename: 'Function', name: string, slug: string }, run: { __typename: 'FunctionRunV2', id: string, status: Types.FunctionRunStatus } | null }> } | null };

export type GetRunTraceQueryVariables = Types.Exact<{
  runID: Types.Scalars['String']['input'];
}>;
...
export type GetTraceResultQueryVariables = Types.Exact<{
...
export type GetTriggerQueryVariables = Types.Exact<{
  runID: Types.Scalars['String']['input'];
}>;
...
export type GetWorkerConnectionsQueryVariables = Types.Exact<{
  appID: Types.Scalars['UUID']['input'];
  startTime: Types.InputMaybe<Types.Scalars['Time']['input']>;
  status: Types.InputMaybe<Array<Types.ConnectV1ConnectionStatus> | Types.ConnectV1ConnectionStatus>;
  timeField: Types.ConnectV1WorkerConnectionsOrderByField;
  cursor?: Types.InputMaybe<Types.Scalars['String']['input']>;
  orderBy?: Types.InputMaybe<Array<Types.ConnectV1WorkerConnectionsOrderBy> | Types.ConnectV1WorkerConnectionsOrderBy>;
...
export type CountWorkerConnectionsQueryVariables = Types.Exact<{
  appID: Types.Scalars['UUID']['input'];
  startTime: Types.Scalars['Time']['input'];
  status: Types.InputMaybe<Array<Types.ConnectV1ConnectionStatus> | Types.ConnectV1ConnectionStatus>;
}>;
...
export type GetEventsV2QueryVariables = Types.Exact<{
  cursor: Types.InputMaybe<Types.Scalars['String']['input']>;
  startTime: Types.Scalars['Time']['input'];
  endTime: Types.InputMaybe<Types.Scalars['Time']['input']>;
  celQuery?: Types.InputMaybe<Types.Scalars['String']['input']>;
  eventNames?: Types.InputMaybe<Array<Types.Scalars['String']['input']> | Types.Scalars['String']['input']>;
  includeInternalEvents?: Types.InputMaybe<Types.Scalars['Boolean']['input']>;
}>;
...
export type GetEventV2QueryVariables = Types.Exact<{
  eventID: Types.Scalars['ULID']['input'];
}>;
...
export type GetEventV2PayloadQueryVariables = Types.Exact<{
  eventID: Types.Scalars['ULID']['input'];
}>;
...
export type GetEventV2RunsQueryVariables = Types.Exact<{
  eventID: Types.Scalars['ULID']['input'];
}>;
...
export type CreateDebugSessionMutationVariables = Types.Exact<{
...
export type GetDebugRunQueryVariables = Types.Exact<{
...
export type GetDebugSessionQueryVariables = Types.Exact<{
...
export const RunDeferSummaryFieldsFragmentDoc = new TypedDocumentString(`
  ...
  run {
    ...
    `, {"fragmentName":"RunDeferSummaryFields"});
...
export const GetRunLinkageDocument = new TypedDocumentString(`
