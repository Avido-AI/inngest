...
const CommandBlock = ({
  ...
  useEffect(() => {
    ...
    // code (free identifiers, fragments). monaco-editor >= 0.55 no longer ships
    // the TypeScript worker in the core package, so there are no TypeScript
    // diagnostics to suppress here.
  }, [monaco, dark]);
